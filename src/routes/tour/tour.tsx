  ...
  return (
    <div>
      <div className="py-20 after:content-[''] after:block after:w-[350px] after:bg-black after:h-1">
        <h1 className="text-4xl md:text-6xl font-bold montserrat">
          Meet Our Guides
        </h1>
      </div>
      <div className="flex justify-center items-center m-20 text-center">
        <p className="text-lg font-semibold">
          We believe that the heart of a memorable travel experience lies in the
          hands of an exceptional guide. Our team of passionate and
          knowledgeable guides are not only experts in their field but also avid
          travelers themselves. They are here to share their love for the
      ...
      <div className="grid md:grid-cols-2">
        <div className="space-y-3">
          ...
          <div className="pl-5 space-y-3">
            {content.map((content, index) => (
              <div key={index}>
                <h2 className="after:content-[''] after:block after:w-[100px] after:bg-black after:h-0.5">
        ...
        <div className="hidden md:block">
          <img
            src="https://th.bing.com/th/id/OIP.SaAFCgdzSBX9HNWuQebvzgHaE8?w=282&h=188&c=7&r=0&o=5&dpr=1.3&pid=1.7"
            alt=""
